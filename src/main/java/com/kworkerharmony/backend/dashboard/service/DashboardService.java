...
public class DashboardService {
    ...
    public DashboardSummaryResponse getWorkerDashboard(UserPrincipal userPrincipal) {
        ...
        return new DashboardSummaryResponse(
                ...
                caseChecklistStatusRepository.countByCaseEntityWorkerId(user.getId()),
                caseChecklistStatusRepository.countByCaseEntityWorkerIdAndStatus(user.getId(), ChecklistStatus.COMPLETED),
